...
* Heliactyl Avanzar 7 [confirmed {new Date(1740624267095).toUTCString()} in the [octant](../Hosts/octant.sh.mdx) discord]
* Heliactyl Next 8 (Pistolero)
* Heliactyl Next 9 (Namek) [Going into production the night of {new Date(1743454314848).toUTCString()}]
