...
* He is 16 years old (as of January 21, 2026) 
...
### In other places
* `mark brown`
* `badsk` - has a definition on [Urban Dictionary](https://www.urbandictionary.com/define.php?term=Badsk)
* `atqr`
* `am5z`
* `ampere`
* `ararat`
...
* [GitHub 3](https://github.com/markb143) - alt (not sure)
